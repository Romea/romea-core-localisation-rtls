...
//-----------------------------------------------------------------------------
void RTLSLocalisationPositionEstimator::loadGeometry(const VectorOfEigenVector3d &referenceTagPositions)
{
...
void RTLSLocalisationPositionEstimator::computeGuess_()
{
  ...
  estimate_ = SimpleTrilateration2D::compute(referenceTagPositions_,ranges_,indexesOfAvailableRanges_);
  //    std::cout << " estimate  guess "<< std::endl;
